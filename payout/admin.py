...
class InstructorEarningAdmin(admin.ModelAdmin):
    list_display = ("id", "instructor", "course", "gross_amount", "instructor_amount", "platform_amount", "created_at")
    list_filter = ("course", "instructor")
    search_fields = ("instructor__username", "course__title")
    readonly_fields = ("instructor", "course", "transaction", "gross_amount", "instructor_amount", "platform_amount", "created_at")


@admin.register(PayoutRequest)
class PayoutRequestAdmin(admin.ModelAdmin):
    list_display = ("id", "instructor", "amount", "status", "created_at", "processed_at", "reference_code")
    list_filter = ("status",)
